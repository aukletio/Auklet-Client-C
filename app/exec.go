...
// Logs returns the process's raw logging stream. This stream is used by
// the application to transmit log messages.
func (exec *Exec) Logs() io.Reader { return exec.appLogs }

// Data returns the raw data stream generated by the process's agent. It is
// provided so that a new JSON decoder can be instantiated in the event of a
// decoding error.
func (exec *Exec) Data() io.ReadWriter { return exec.agentData }

// Decoder returns the JSON decoder reading from the Data stream.
